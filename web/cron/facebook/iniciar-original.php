...
if ($arquivos == 0) {
    ...
    if ($query) {
        ...
        while ($contaValor = mysqli_fetch_array($query)) { 
            ...
            if (!empty($contaTokens)) {
                ...
                $url      = "https://graph.facebook.com/v17.0/me/adaccounts?access_token=" . $contaToken .'&limit=500&fields=account_name,account_id,balance,account_status,business_name,amount_spent,name,funding_source_details,age,timezone_name';
                $continua = true;
    ...
    foreach ($arrInserir as $arrDados) {
        ...
        mysqli_query($con, "INSERT INTO facebook_conta_itens (itemNome, itemValor, _contaID, itemSaldoPagar, itemSituacao, itemTotalGasto, itemFormaPagamento, itemTimezoneName, itemTempoAtivo) 
